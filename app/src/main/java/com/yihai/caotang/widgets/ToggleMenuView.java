...
public class ToggleMenuView extends LinearLayout {
    ...
    public static final int CLICK_CONFIG = 1;
    public static final int CLICK_COLLECTION = 2;
    public static final int CLICK_TASK = 3;
    public static final int CLICK_REPOSITORY = 4;
    ...
    public ToggleMenuView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public ToggleMenuView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        ...
        mIvCollection = (ImageView) mRoot.findViewById(R.id.iv_collection);
        ...
        mIvCollection.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                AppContext.getInstance().playEffect();
                mListener.onClick(v, CLICK_COLLECTION);
            }
        });
    ...
    public void toggle(boolean isToggled) {
        final float translateDistance = getWidth() - mIvToggle.getWidth() - ViewUtils.dip2px(getContext(), 20);
        if (isToggled) {
