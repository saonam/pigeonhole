package com.yihai.caotang.widgets.overlay;
...
public class WalkRouteOverlay extends RouteOverlay {
    ...
    public WalkRouteOverlay(Context context, AMap amap) {
        super(context);
        this.mAMap = amap;
    }
...
//        }
    ...
    public void setPath(WalkPath walkPath, LatLonPoint start, LatLonPoint end) {
