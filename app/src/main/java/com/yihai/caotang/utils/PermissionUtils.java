...
public class PermissionUtils {
    ...
    public final static int ACCESS_FINE_LOCATION_CODE = 103;
...
//                new PermissionModel("相册", Manifest.permission.READ_EXTERNAL_STORAGE, "我们需要访问您的相册",
...
//    };
    ...
    public PermissionUtils(Activity activity, PermissionModel[] models) {
        mActivity = activity;
